...
public class Residente extends Vehiculo{
   ...
   private static final double precioMinuto = 0.004;
...
//Residente(marca, modelo, tipo, color, numPuertas, matricula, tiempoAcumulado)
    public Residente(String marca, String modelo, String tipo, String color, int numPuertas, String matricula, int tiempoAcumulado) {
        super(matricula);
        this.marca = marca;
        this.modelo = modelo;
        this.tipo = tipo;
