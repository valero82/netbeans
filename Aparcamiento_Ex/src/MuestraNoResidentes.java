 ...
 * @author JaimeLap
 */
public class MuestraNoResidentes extends javax.swing.JFrame {
    ...
    public MuestraNoResidentes() {
        try {
            ...
            con.conecta();
            con.crearSentencia();
            con.ejecutaSQL("SELECT * FROM vehiculos WHERE clase = 02");     
            try {
                if(con.rs.first())
                    mostrar();
                if (con.rs.isFirst()){
    ...
    private void initComponents() {
        ...
        jLabel1.setText("FICHAS NO RESIDENTES");
